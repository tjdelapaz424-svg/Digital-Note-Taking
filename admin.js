...
function renderRows() {
  ...
  rows.forEach(u => {
    ...
    const passwordCell = u.authProvider === 'google'
      ...
      : `<span style="font-family:monospace;">${escapeHtml(u.password || '')}</span>${u.linkedGoogle ? ' <span class="pill" style="background:#E3D6ED;color:var(--green-dark);font-size:10px;">+Google</span>' : ''}`;
